...
df = ler_tripinfo('outputs/baseline_maxpressure.xml')
...
with open('outputs/resultados_baseline_maxpressure.txt', 'w', encoding='utf-8') as arquivo:
...
print("\nSucesso! Os resultados foram salvos no arquivo 'outputs/resultados_baseline_maxpressure.txt'.")