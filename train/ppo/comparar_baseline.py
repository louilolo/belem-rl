"""Roda os 6 modelos finais (PPO) até TODOS os veículos completarem a viagem (igual ao
...
def rodar_e_medir(nome_recompensa, com_optuna):
    ...
    tripinfo_path = os.path.abspath(f'outputs/tripinfo_ppo_{tag}_{nome_recompensa}.xml')
...
if __name__ == "__main__":
    ...
    caminho = 'outputs/comparacao_baseline_ppo.csv'
